...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('⌬ Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url='https://t.me/moviespremium')
                ],[
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_photo(
            ...
            photo="https://te.legra.ph/file/71ef1febba80056d88a37.jpg",
            caption="**ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴊᴏɪɴᴇᴅ ɪɴ ᴏᴜʀ ᴄʜᴀɴɴᴇʟ 😞**\n\nɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴛʜᴇ ᴍᴏᴠɪᴇ ғɪʟᴇ﹐ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ **❑ ➊ ❆ Jᴏɪɴ Oᴜʀ Cʜᴀɴɴᴇʟ ❆** ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴀɴᴅ ᴊᴏɪɴ ᴏᴜʀ ʙᴀᴄᴋ-ᴜᴘ ᴄʜᴀɴɴᴇʟ﹐ ᴛʜᴇɴ ᴄʟɪᴄᴋ ᴏɴ **❑ ➋ ↻ Tʀʏ Aɢᴀɪɴ** !!\n\nᴛʜᴇɴ ʏᴏᴜ ᴡɪʟʟ ɢᴇᴛ ᴛʜᴇ ᴍᴏᴠɪᴇs ғɪʟᴇs...",
        ...
        for file in files:
            ...
            if not await check_verification(client, message.from_user.id) and VERIFY == True:
                btn = [[
                    ...
                    InlineKeyboardButton("⁉️ ʜᴏᴡ ᴛᴏ ᴠᴇʀɪꜰʏ ⁉️", url='https://t.me/orgpremium/7')
                ],[
                    InlineKeyboardButton('✨ ʙᴜʏ ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ : ʀᴇᴍᴏᴠᴇ ᴀᴅꜱ ✨', callback_data="premium_info")
                ]]
                await message.reply_text(
...
async def plan(client, message):
    ...
    btn = [[
	    InlineKeyboardButton("📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ʜᴇʀᴇ", url="https://t.me/ORGSupport")],[InlineKeyboardButton("❌ ᴄʟᴏꜱᴇ ❌", callback_data="close_data")
    ]]
...
@Client.on_message((filters.command(["request", "Request", "REQUEST"]) | filters.regex("#request") | filters.regex("#Request") | filters.regex("#REQUEST")) & filters.group)
async def requests(bot, message):
    ...
    if message.reply_to_message and SUPPORT_CHAT_ID == message.chat.id:
        ...
        try:
            if REQST_CHANNEL is not None:
                ...
                reported_post = await bot.send_message(chat_id=REQST_CHANNEL, text=f"<b>Request By : {mention} ({reporter})\n\n#Request : {content}</b>", reply_markup=InlineKeyboardMarkup(btn))
                success = True
            elif len(content) >= 3:
                for admin in ADMINS:
                    btn = [[
                    ...
                    reported_post = await bot.send_message(chat_id=admin, text=f"<b>Request By : {mention} ({reporter})\n\n#Request : {content}</b>", reply_markup=InlineKeyboardMarkup(btn))
                    success = True
            else:
                if len(content) < 3:
    ...
    if success:
        ...
        btn = [[
                InlineKeyboardButton('Join Channel', url=f"https://t.me/c/2127187291/999999"),
