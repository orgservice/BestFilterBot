...
async def give_filter(client, message):
    if message.chat.id == SUPPORT_CHAT_ID or message.chat.id == MASTER_CHAT_ID:
        ...
        if total_results == 0:
            ...
            return await message.reply_photo(photo="https://graph.org/file/54fde3e34103198dabaea.jpg", caption=script.PREMIUM_TEXT.format(message.from_user.mention), reply_markup=InlineKeyboardMarkup(button))
