...
from umongo import Instance, file_type, Document, fields
...
async def get_search_results(chat_id, query, file_type=video+document, max_results=10, offset=0, filter=False):
