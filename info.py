...
URL = "https://primefilterbot-3fa0b05937aa.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://primefilterbot-3fa0b05937aa.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://primefilterbot-3fa0b05937aa.herokuapp.com/".format(FQDN)
else:
    URL = "https://primefilterbot-3fa0b05937aa.herokuapp.com/".format(FQDN)
