...
URL = "https://orgmovies-pre.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://orgmovies-pre.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://orgmovies-pre.koyeb.app/".format(FQDN)
else:
    URL = "https://orgmovies-pre.koyeb.app/".format(FQDN)
