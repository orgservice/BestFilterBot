...
URL = "https://primefiltersbot-49ec5e9cc79b.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://primefiltersbot-49ec5e9cc79b.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://primefiltersbot-49ec5e9cc79b.herokuapp.com/".format(FQDN)
else:
    URL = "https://primefiltersbot-49ec5e9cc79b.herokuapp.com/".format(FQDN)
