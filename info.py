...
URL = "https://imaxfilterbot-8dd8b383d80d.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://imaxfilterbot-8dd8b383d80d.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://imaxfilterbot-8dd8b383d80d.herokuapp.com/".format(FQDN)
else:
    URL = "https://imaxfilterbot-8dd8b383d80d.herokuapp.com/".format(FQDN)
