...
URL = "https://orgmovies-imax.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://orgmovies-imax.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://orgmovies-imax.koyeb.app/".format(FQDN)
else:
    URL = "https://orgmovies-imax.koyeb.app/".format(FQDN)
