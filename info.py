...
URL = "https://orgmovies-ec19fa80c1a3.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://orgmovies-ec19fa80c1a3.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://orgmovies-ec19fa80c1a3.herokuapp.com/".format(FQDN)
else:
    URL = "https://orgmovies-ec19fa80c1a3.herokuapp.com/".format(FQDN)
