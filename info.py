...
BOT_TOKEN = environ.get('BOT_TOKEN', "6738501232:AAEQ7CGKo9PDkYmz_m1LGUX1HrD-UbvAjz4")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://orgprime:orgprime@orgprime.cjohlen.mongodb.net/?retryWrites=true&w=majority")
...
URL = "https://orgmoviesbot.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://orgmoviesbot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://orgmoviesbot.onrender.com/".format(FQDN)
else:
    URL = "https://orgmoviesbot.onrender.com/".format(FQDN)
