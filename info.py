...
URL = "https://primefilterbot-2c76.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://primefilterbot-2c76.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://primefilterbot-2c76.onrender.com/".format(FQDN)
else:
    URL = "https://primefilterbot-2c76.onrender.com/".format(FQDN)
