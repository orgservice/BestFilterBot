...
BOT_TOKEN = environ.get('BOT_TOKEN', '6892047030:AAFsifL41wvtXqyP4QdtlpmVkPQWxttTbqw')
...
FQDN = str(getenv('FQDN', '147.79.68.161:8086')) if not ON_HEROKU or getenv('FQDN', '147.79.68.161:8086') else APP_NAME+'.herokuapp.com'
