...
BOT_TOKEN = environ.get('BOT_TOKEN', '6017050662:AAHkv63EPgJkTovhIvd4J0mK56mjbrl42z4')
...
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/a0e3fe92157f375ca4869.png")
...
SECONDDB_URI = environ.get('SECONDDB_URI', "mongodb+srv://orgprime:orgprime@imax2nd.peplvim.mongodb.net/?retryWrites=true&w=majority")
...
if 'DYNO' in environ:
    ON_HEROKU = True
    APP_NAME = environ.get('APP_NAME', "imaxfiltersbots")
else:
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '0.0.0.0'))
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN') else APP_NAME+'.herokuapp.com'
URL = "https://imaxfilterbots-d18c70c77557.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://imaxfilterbots-d18c70c77557.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://imaxfilterbots-d18c70c77557.herokuapp.com/".format(FQDN)
else:
    URL = "https://imaxfilterbots-d18c70c77557.herokuapp.com/".format(FQDN)
