...
URL = "https://orgmovies.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://orgmovies.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://orgmovies.onrender.com/".format(FQDN)
else:
    URL = "https://orgmovies.onrender.com/".format(FQDN)
