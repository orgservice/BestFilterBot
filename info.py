...
BOT_TOKEN = environ.get('BOT_TOKEN', "6817574477:AAECBF8lTnPxX8Dc3BNEdCQ5bplPhxDXiXg")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://filter:filter@filterbot.mbe9f6d.mongodb.net/?retryWrites=true&w=majority")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/orgpremium')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001834909176'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001834909176')).split()]
...
URL = "https://orgmoviesbot.herokuapp.com/m".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://orgmoviesbot.herokuapp.com//".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://orgmoviesbot.herokuapp.com/".format(FQDN)
else:
    URL = "https://orgmoviesbot.herokuapp.com/m/".format(FQDN)
